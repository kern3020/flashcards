...
public class FetchCardsByDeckIdTest {
	...
	@Test
	public void testFetchByDeck() {
		List<Deck> decks = jdbcFlashcardsDao.fetchAllDecks();
		Integer i = decks.get(2).getId();
		List<Card> cards = jdbcFlashcardsDao.fetchCardsByDeck(i);
